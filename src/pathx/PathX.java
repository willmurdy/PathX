...
public class PathX {
    ...
    public enum PathXPropertyType
    {
        ...
        CLOSE_MOUSE_OVER_BUTTON_IMAGE_NAME,
        BACK_BUTTON_IMAGE_NAME,
        BACK_MOUSE_OVER_BUTTON_IMAGE_NAME,
        START_BUTTON_IMAGE_NAME,
        START_MOUSE_OVER_BUTTON_IMAGE_NAME,
        TRY_AGAIN_BUTTON_IMAGE_NAME,
        TRY_AGAIN_MOUSE_OVER_BUTTON_IMAGE_NAME,
        LEAVE_TOWN_BUTTON_IMAGE_NAME,
        LEAVE_TOWN_MOUSE_OVER_BUTTON_IMAGE_NAME,
        ...
        MUTE_BUTTON_IMAGE_NAME,
        MUTE_MOUSE_OVER_BUTTON_IMAGE_NAME,
        MUTE_SELECTED_BUTTON_IMAGE_NAME,
        MUTE_SELECTED_MOUSE_OVER_BUTTON_IMAGE_NAME,

        //Specials Image Names
        IMAGE_SPECIALS_REDLIGHT,
        IMAGE_SPECIALS_REDLIGHT_MOUSE_OVER,
        IMAGE_SPECIALS_FLAT_TIRE,
        IMAGE_SPECIALS_FLAT_TIRE_MOUSE_OVER,
        IMAGE_SPECIALS_INTANGABLE,
        IMAGE_SPECIALS_INTANGABLE_MOUSE_OVER,
        IMAGE_SPECIALS_INVINCIBILITY,
        IMAGE_SPECIALS_INVINCIBILITY_MOUSE_OVER,
        IMAGE_SPECIALS_SPEED,
        IMAGE_SPECIALS_SPEED_MOUSE_OVER,
        IMAGE_SPECIALS_FLY,
        IMAGE_SPECIALS_FLY_MOUSE_OVER,
