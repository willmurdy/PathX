...
////            FileOutputStream fos = new FileOutputStream(fileToOpen);
////            BufferedOutputStream bis = new BufferedOutputStream(baos);
////            
////            // NOW WE NEED TO LOAD THE DATA FROM THE BYTE ARRAY
////           // DataInputStream dis = new DataInputStream(bais);
////            DataOutputStream dop = new DataOutputStream(bis);
////            
////            String levelname = ((SortingHatDataModel)miniGame.getDataModel()).getCurrentLevel();
////            
////            dop.writeUTF(levelname);
////            dop.writeUTF(record.getAlgorithm(levelname));
////            dop.writeInt(record.getGamesPlayed(levelname));
////            dop.writeInt(record.getWins(levelname));
////            dop.writeInt(record.getPerfectWins(levelname));
////            dop.writeLong(record.getFastestPerfectWin(levelname));
////            
////           // baos.writeTo(dop);
////            
////            //bis.write();
